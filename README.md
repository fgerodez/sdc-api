...
```
C'est une interface Spring Data standard qui peut être implémentée via spring-data-jpa pour les bdd classiques, via spring-data-mongodb pour le NoSQL ou via l'implémentation SimpleProductRepository pour un fichier plat.
